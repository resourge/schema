...
import { type BaseRuleConfig, getError, type ValidationContext } from './BaseRule';
...
export type RuleConfig<Value = any, T = any> = BaseRuleConfig<'Rule', Value, T, AsyncRuleMethod<Value, T> | RuleMethod<Value, T>> & {
	isAsync: boolean
